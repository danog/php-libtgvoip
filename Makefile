...
INCLUDES		=	-Ilibtgvoip -I/usr/include/opus -I/usr/include/openssl/ -Ilibtgvoip/webrtc_dsp
CXXFLAGS		=	${INCLUDES} -Wall -O3 -c -std=c++11 -fpic -finline-functions -ffast-math -Os -fno-strict-aliasing -DUSE_KISS_FFT -DFIXED_POINT -DPHP_LIBTGVOIP -DWEBRTC_POSIX -DTGVOIP_USE_DESKTOP_DSP -DWEBRTC_APM_DEBUG_DUMP=0 -g -DTGVOIP_USE_CXX11_LIB -o
CFLAGS			=	${INCLUDES} -O3 -DUSE_KISS_FFT -fexceptions -fpic -DTGVOIP_USE_CXX11_LIB -DPHP_LIBTGVOIP -DWEBRTC_POSIX -DTGVOIP_USE_DESKTOP_DSP -DWEBRTC_APM_DEBUG_DUMP=0

LDFLAGS		=	-shared
LDFLAGS		+=	-lphpcpp ${INCLUDES} -lopus
